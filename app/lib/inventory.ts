...
export const heavyEquipmentListings: EquipmentItem[] = [
  {
    ...
    year: 2004,
    model: "988G",
    location: "Valle de Sula Store / Cortes, HN",
  ...
  },
  {
    ...
    year: 2005,
    model: "966G",
    location: "San Pedro Sula Branch, HN",
    condition: "Pre-Owned",
    hours: "11,200 hrs",
    price: "Inquire for Pricing",
...
export const storeInfo = {
  ...
  subname: "Tracto Repuestos - Valle de Sula #2",
  tagline: "Importación Directa de Repuestos y Maquinaria Pesada para Construcción y Minería",
  location: "Valle de Sula #2, San Pedro Sula, Cortés, Honduras",
  coverage: "Servicio en San Pedro Sula, Choloma, Chamelecón, Guanacaste, La Lima y Envíos a Nivel Nacional e Internacional",
  phone: "+504 2550-0000 / +504 9990-1234",
  email: "ventas@tractorepuestoshn.com",
  hours: [
    { days: "Lunes a Viernes", time: "08:00 AM - 05:00 PM" },
    { days: "Sábado", time: "08:00 AM - 12:00 PM" },
